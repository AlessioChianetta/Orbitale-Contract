...
5:36:36 PM [express] GET /api/user 401 in 5ms
5:36:44 PM [express] GET /api/user 304 in 437ms :: {"id":1,"username":"alessio","password":"db868cff…
5:36:45 PM [express] GET /api/templates 304 in 580ms :: []
5:36:45 PM [express] GET /api/stats 304 in 726ms :: {"totalContracts":0,"signedContracts":0,"pending…
5:37:10 PM [express] POST /api/templates 201 in 1083ms :: {"id":1,"name":"Turbo","description":"Turb…
5:37:11 PM [express] GET /api/templates 200 in 577ms :: [{"id":1,"name":"Turbo","description":"Turbo…
5:37:29 PM [express] POST /api/logout 200 in 1165ms
5:38:03 PM [express] POST /api/register 201 in 1395ms :: {"id":2,"username":"orbitale","password":"0…
5:38:04 PM [express] GET /api/contracts 200 in 592ms :: []
5:39:16 PM [express] POST /api/contracts 400 in 880ms :: {"message":"Invalid contract data","errors"…
...
error: terminating connection due to administrator command
  ...
  client: NeonClient {
    ...
    connectionParameters: ConnectionParameters {
      ...
      database: 'neondb',
      port: 5432,
      host: 'ep-proud-darkness-a2ucp0gc.eu-central-1.aws.neon.tech',
      binary: false,
      options: undefined,
      ssl: {},
      client_encoding: '',
      ...
      stream: Socket {
        ...
        ws: <ref *1> WebSocket {
          ...
          _socket: TLSSocket {
            ...
            _SNICallback: null,
            servername: 'ep-proud-darkness-a2ucp0gc.eu-central-1.aws.neon.tech',
            alpnProtocol: false,
            authorized: true,
            ...
            _hadError: false,
            _parent: null,
            _host: 'ep-proud-darkness-a2ucp0gc.eu-central-1.aws.neon.tech',
          ...
          _redirects: 0,
          _autoPong: true,
          _url: 'wss://ep-proud-darkness-a2ucp0gc.eu-central-1.aws.neon.tech/v2',
          _req: null,
    ...
    config: {
      connectionString: 'postgresql://neondb_owner:npg_oWSaJt1r4EyT@ep-proud-darkness-a2ucp0gc.eu-central-1.aws.neon.tech/neondb?sslmode=require',
      max: 10,
      maxUses: Infinity,
