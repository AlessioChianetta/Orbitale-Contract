// Helper condivisi per i campi anagrafici del cliente.
// Usati da server (validazione contratti in modalità "client_fill") e
// dal client (UI co-fill, missing-data panel, contract-form).
